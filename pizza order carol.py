...
class Main:
    def __init__(self, parent):        
        ...
        global images
        global gou_images
        self.totalprice = 0 #the totalprize of one order
        images = []
        gou_images = []
        ...
        self.total = 0# total number of pizza
...
############retular pizza increment by one(+)############
...
############gourmet pizza increment by one(+)############       
...
############ deliveryPlaceOrder class for 'delivery' Order ############
#******************************************************
...
############ pickupPlaceOrder class for 'pickup' Order ############
#******************************************************
